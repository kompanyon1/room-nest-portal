          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-muted-foreground">
                Наши ценности лежат в основе всего, что мы делаем, обеспечивая исключительный опыт для каждого гостя
              </p>
            </div>
          </FadeIn>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <FadeInStagger direction="right" distance={30}>
              ...
              <ValueCard 
                ...
                description="Мы привержены принципам экологической ответственности и устойчивого развития, внедряя инновационные практики, которые минимизируют наше воздействие на окружающую среду."
              />
            </FadeInStagger>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-muted-foreground">
                За каждым великолепным опытом стоит команда профессионалов, стремящихся сделать ваше пребывание исключительным
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-white/80">
                Мы гордимся наградами и признанием, которые подтверждают наше стремление к совершенству
              </p>
            </div>
          </FadeIn>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <FadeInStagger>
              <div className="text-center">
                ...
                <h4 className="font-serif text-lg font-medium mb-2">Лучший бутик-отель</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-serif text-lg font-medium mb-2">Выбор путешественников</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-serif text-lg font-medium mb-2">Премия за дизайн</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-serif text-lg font-medium mb-2">Лучший сервис</h4>
